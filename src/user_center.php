...
<?php 
$query = "select * from user where id = {$_COOKIE['user']['id']}";
$result = execute($conn, $query);
		...
		<div class="col-lg-6">
			<form id="regform" class="form-horizontal" method="post"
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="email" class="form-control" id="inputEmail3" value="<?php echo $data['email']?>"
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="inputPassword" value="<?php echo $data['cellphone']?>"
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="date" class="form-control" id="inputPassword3" value=""
							name='brithday' placeholder="<?php echo $data['birthday']?>">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<button name='submit' type="submit" class="btn btn-success  ">修改</button>
					</div>
				</div>
			</form>
		</div>
